...
namespace DCTStore.Data.Migrations
{
    ...
    [Migration("20240918130804_typedownloadlinks")]
    partial class typedownloadlinks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DCTStore.Models.Lyric", b =>
                {
                    ...
                    b.Property<string>("LyricMediaLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LyricThumbnail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DCTStore.Models.Music", b =>
                {
                    ...
                    b.Property<string>("MusicMediaLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DCTStore.Models.Sermon", b =>
                {
                    ...
                    b.Property<string>("SermonMediaLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DCTStore.Models.Sermon", b =>
                {
                    ...
                    b.HasOne("DCTStore.Models.Minister", "Minister")
                        .WithMany()
